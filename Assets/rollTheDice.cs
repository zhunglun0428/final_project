...
public class rollTheDice : MonoBehaviour
{
    ...
    public player2Control _player2Control;
    ...
    public IEnumerator BuyOrPay(){
        ...
        for(int i=0;i<property.Length;i++){
            if(property[i].tag==tag_){
                if(property[i].GetComponent<MeshRenderer>().material.color==color_list[1]){
                    RespondDialogUI.Instance.ShowRespond("這是別人的土地 損失1000元", () => {
                        
                        P1_money-=1000;
                        P1_moneyTxt.text = "" + P1_money;
                        _player2Control.SetMoney();
                    }, () => {
                    });
                    turnOrnot++;
                    break;
                    ...
                    if(random1==0){
                        ...
                        //P1_money = Convert.ToInt32(P1_moneyTxt.text);
                                if(canPayForProperty){
                                    property[i].GetComponent<MeshRenderer>().material.color = color_list[0];
                                    P1_money-=2000;
                                    P1_moneyTxt.text=""+P1_money;
                                    P1_land ++;
